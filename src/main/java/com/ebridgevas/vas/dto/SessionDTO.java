...
public class SessionDTO
        extends SessionKeyDTO {

    private String payload; //  = agiRequest.getParameter("bundle_id");

    public SessionDTO(SessionKeyDTO key) {
        super(key.getCallerId(), key.getCalledId(), key.getCallId());
    }
    ...
    // private String actionId = agiRequest.getParameter("action_id");
