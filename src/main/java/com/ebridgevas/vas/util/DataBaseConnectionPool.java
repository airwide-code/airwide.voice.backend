...
//        ConnectionFactory cf = new DriverConnectionFactory(new com.mysql.jdbc.Driver(), "jdbc:mysql://localhost:3306/vas", props);
    ...
    public static Connection getConnection(String connectionUrl) throws Exception {
        ...
        //  ConnectionFactory cf = new DriverConnectionFactory(new com.mysql.jdbc.Driver(), "jdbc:mysql://localhost:3306/vas", props);
        // mysql -h 192.1.1.57 -u root -p
        ConnectionFactory cf = new DriverConnectionFactory(new com.mysql.jdbc.Driver(), connectionUrl, props);
//        ConnectionFactory cf = new DriverConnectionFactory(new com.mysql.jdbc.Driver(), "jdbc:mysql://localhost:3306/vas", props);
